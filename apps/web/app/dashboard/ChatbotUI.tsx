...
export default function ChatbotUI() {
  ...
  return (
    <>
      {/* ── Toggle button + anchored chat window ── */}
      <div className="relative z-50" title="AI Assistant">
        <motion.button
          id="chatbot-toggle-btn"
          onClick={() => setIsOpen((p) => !p)}
          className="relative w-12 h-12 rounded-full bg-[#127eeb] flex items-center justify-center cursor-pointer shadow-lg"
        ...
        {/* ── Chat window — anchored to toggle button ── */}
        <AnimatePresence>
          {isOpen && (
            <motion.div
              id="chatbot-window"
              ...
              className="absolute top-14 right-0 z-50 w-[92vw] max-w-[360px] rounded-2xl overflow-hidden shadow-2xl border border-white/10"
              style={{
            ...
            >
              ...
              >
                {messages.length === 0 && (
                  <div className="flex flex-col items-center gap-1 text-center mt-2 mb-2">
                    ...
                    <p className="text-xs text-gray-400">
                      Ask about emergency response in Sri Lanka
                    </p>
                  </div>
                )}
                      ...
                      {msg.role === "user" ? (
                        ...
                        <ReactMarkdown
                          ...
                          components={{
                            ...
                            p: ({ node, ...p }) => (
                              <p className="my-1 leading-relaxed" {...p} />
                            ),
                            strong: ({ node, ...p }) => (
                              <strong
                ...
                {isLoading && (
                  <div className="flex justify-start">
                    ...
                    <div className="px-4 py-3 rounded-2xl rounded-bl-[4px] flex items-center gap-2.5 bg-white/10">
              ...
              {messages.length === 0 && (
                <div
                  className="px-4 pb-4 flex flex-col gap-2 flex-shrink-0"
                  style={{ background: "transparent" }}
                >
